...
#ifndef SOC_MICROCHIP_PIC32CK_SG_GC_COMMON_MCHP_DT_HELPER_H_
#define SOC_MICROCHIP_PIC32CK_SG_GC_COMMON_MCHP_DT_HELPER_H_
...
#endif /* SOC_MICROCHIP_PIC32CK_SG_GC_COMMON_MCHP_DT_HELPER_H_ */
